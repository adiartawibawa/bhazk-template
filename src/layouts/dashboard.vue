...
<template>
  <div class="relative min-h-screen lg:flex">
    ...
    >
      <div class="flex flex-col items-center flex-1 space-y-6">
        ...
        <nav class="flex flex-col items-center space-y-6">
          <router-link
            to="#"
            class="p-3 transition-colors duration-300 bg-white rounded-lg"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      <div class="flex justify-center py-5 border-t border-gray-600">
        ...
        >
          <svg
            class="w-6 h-6 opacity-100 group-hover:stroke-blue-700"
            viewBox="0 0 24 24"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
    ...
    >
      <header
        class="flex items-center justify-between h-20 px-6 bg-white border-b"
      >
          ...
          <div class="relative">
            ...
            >
              ...
              <div class="flex items-center md:-mx-2">
                ...
                <img
                  class="flex-shrink-0 w-12 h-12 overflow-hidden bg-gray-100 rounded-full md:mx-2"
